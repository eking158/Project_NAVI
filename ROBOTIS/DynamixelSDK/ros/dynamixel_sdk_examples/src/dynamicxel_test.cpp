...
#define DXL8_ID               8              // DXL7 ID
#define DXL9_ID               9              // DXL7 ID
...
int main(int argc, char ** argv)
{
  ...
  ros::init(argc, argv, "dynamicxel_test");
  ros::NodeHandle nh;
  //ros::ServiceServer sync_get_position_srv = nh.advertiseService("/sync_get_position", syncGetPresentPositionCallback);
  ros::Subscriber sync_set_position_sub = nh.subscribe("/dynamicxel_set_position", 10, syncSetPositionCallback);
  ros::spin();
